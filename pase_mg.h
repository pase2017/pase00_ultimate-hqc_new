...
PASE_Int PASE_ParCSRMGInit( MPI_Comm comm,
			    ...
			    PASE_Int block_size,
			    PASE_Int* seed);
PASE_Int PASE_MGSolve( PASE_Solver solver);
PASE_Int pase_MGIteration( PASE_Solver solver);
PASE_Int pase_MGPreSmooth( PASE_Solver solver);
PASE_Int pase_MGPostSmooth( PASE_Solver solver);
PASE_Int pase_ParCSRMGAuxMatrixCreate( PASE_Solver solver);
PASE_Int pase_MGAuxMatrixCreate(PASE_Solver solver); 
PASE_Int pase_MGPostCorrection( PASE_Solver solver);
PASE_Int pase_MGRestart( PASE_Solver solver);
PASE_Int PASE_MGDestroy( PASE_Solver solver);
...
PASE_Int pase_MGErrorEstimate( PASE_Solver solver);

PASE_Int pase_MGDirSolver(PASE_Solver solver);
PASE_Int pase_MGSmootherCG(PASE_Solver solver);
PASE_Int pase_MGInAuxSmootherCG(PASE_Solver solver);
#ifdef __cplusplus
}
#endif
